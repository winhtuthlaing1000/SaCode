...
၂- python3 generate_drive_token.py    
https:// လင့်ခ်ကို browser တွင် accept ပေးပါ။ console တွင်ဝင်ခဲ့သာ gmailဖစ်ရမည်

၃- python3 gen_sa_accounts.py --enable-services သင့်project name
https:// လင့်ခ်ကို browser တွင် accept ပေးပါ။ console တွင်ဝင်ခဲ့သာ gmailဖစ်ရမည်

၄- python3 gen_sa_accounts.py --create-sas သင့်project name

၅- python3 gen_sa_accounts.py --download-keys သင့်project name
